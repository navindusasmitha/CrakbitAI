...
The project is currently in **early development / Security MVP** stage. Our immediate priority is to build useful defensive security technology before any production blockchain or CRKBIT utility asset launch.
...
The status of planned features is intentionally shown clearly. We do not present roadmap items as already completed.

## Roadmap

Our current development sequence is:
...
6. Crakbit testnet research
7. Security review and public testing
8. Mainnet consideration only after technical validation

See [`ROADMAP.md`](ROADMAP.md) for milestones and target phases.

## Open Source

Crakbit AI intends to release useful developer-security components openly where practical, including selected scanners, rules, SDKs, documentation and testnet tooling.
...
Crakbit AI is currently raising funds to support development of the Security MVP, security research, infrastructure, developer tools, documentation and testing.
...
**CRKBIT has not been launched. There is currently no official CRKBIT presale or production token contract.**

The proposed CRKBIT utility asset is a long-term research item intended for a future Crakbit network, subject to technical development, public testing, security review and applicable legal/regulatory consideration.

Any account, website or contract claiming to sell an official CRKBIT token before an announcement from the official project channels should be treated as unverified.
...
Please read [`SECURITY.md`](SECURITY.md) before reporting a vulnerability in this repository or project infrastructure.
...
- Funding / Giveth: project submitted; public listing review in progress
